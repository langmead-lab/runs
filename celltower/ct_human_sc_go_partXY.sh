...
REGION="us-east-1"
EC2_CONFIG="--ec2-subnet-id ${US_EAST_1YX}"

# EBS config
EBS_CONFIG="--use-ebs --ebs-volume-type gp2 --ebs-volumes-per-instance 6 --ebs-gb 250"

SPECIES=human
NM="ct_${SPECIES}_sc_part${PART}"
LNM="ct_${SPECIES}_sc_part${PART}"
BUCKET="langmeadlab-public-ct-${SPECIES}"
...
TERMINATION="--keep-alive --termination-protected"
